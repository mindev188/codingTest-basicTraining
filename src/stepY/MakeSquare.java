...
public class MakeSquare {
    ...
    public static void main(String[] args) {
        for (int[] arr : solution(new int[][] {{572, 22, 37}, {287, 726, 384}, {85, 137, 292}, {487, 13, 876}})) {
            for (int a : arr) {
    ...
    public static int[][] solution(int[][] arr) {
        // 행와 열 중 더 큰값에 맞춰 배열을 새로 생성한다.
        // 이후 arr의 모든 값을 복사
        int maxLength = arr.length > arr[0].length ? arr.length : arr[0].length;

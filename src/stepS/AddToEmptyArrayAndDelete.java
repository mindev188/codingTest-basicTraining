 ...
 */
public class AddToEmptyArrayAndDelete {

    public static void main(String[] args) {
        for (int a : solution(new int[] {3, 2, 4, 1, 3}, new boolean[] {true, false, true, false, false})) {
    ...
    public static int[] solution(int[] arr, boolean[] flag) {
        ...
        //  true라면 X의 뒤에 arr[i]를 arr[i] × 2 번 추가하고, flag[i]가 false라면 X에서 마지막 arr[i]개의 원소를 제거한다

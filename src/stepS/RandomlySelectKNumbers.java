 ...
 */
public class RandomlySelectKNumbers {

    public static void main(String[] args) {
        for (int a : solution(new int[] {0,1,1,2,2,3}, 3)) {
            System.out.println(a);
        }
        System.out.println("--");
        for (int a : solution(new int[] {0,1,1,1,1}, 4)) {
            System.out.println(a);
        }
        System.out.println("--");
        for (int a : solution(new int[] {0,0,3,3,3,2,-1}, 4)) {
            System.out.println(a);
        }
    }

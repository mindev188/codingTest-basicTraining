...
public class SeparateWithSpaces2 {
    ...
    public static void main(String[] args) {
        for (String a : solution("i love you")) {
    ...
    public static String[] solution(String my_string) {
        ...
        String tmp = "";
        // my_string 문자열을 반복하며 공백은 pass, char은 추가한다. 
        // 추가하는 과정에서 다음 char이 공백 또는 없는 경우 해당 값까지 add 및 초기화
        ...
        for (int i = 0; i < my_string.length(); i++) {
            if (' ' == (my_string.charAt(i))) {
                ...
                if (i + 1 < my_string.length() && ' '==my_string.charAt(i+1)) {
                    list.add(tmp);
                    tmp = "";
                }
            }
        ...
        public static String[] solution_org1(String my_string) {
        String[] answer = {};
